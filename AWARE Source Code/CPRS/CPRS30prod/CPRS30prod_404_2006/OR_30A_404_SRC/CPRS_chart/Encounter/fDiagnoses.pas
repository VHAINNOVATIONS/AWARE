...
var
  ICDCode, ICDPar, SCTCode, SCTPar, plIEN, msg, SecItem, InputStr, OrigProbStr: String;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            //ask for SNOMED CT
            LexiconLookup(SCTCode, LX_SCT, 0, True, InputStr, TX_PROB_LACKS_SCT_CODE);
...
begin
  // look-up SNOMED CT
  LexiconLookup(Code, LX_SCT, 0, False, ADiagnosis.Narrative, TX_ICD_LACKS_SCT_CODE);
  if (Code = '') then
  begin
    ckbDiagProb.Checked := False;
  end
