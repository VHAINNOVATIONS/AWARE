...
//Modifed: 7/26/99   //AWARE change 7/6/11
//By: Robert Bott
//Location: ISL
//Description of Mod:
...
uses rCore, uCore, uConst, fReview, uPCE, rPCE, VA508AccessibilityRouter,
  VAUtils,fPtsel;    //AWARE change with fPtsel;
  //VAUtils;
...
begin
  ...
  //AWARE change
  //pgeVisit.ActivePage := tabClinic;
  if fPtSel.tTabsheet = 1 then pgeVisit.ActivePage := tabNewVisit  //tabClinic; //tabNewVisit ;  //tabClinic;
  else pgeVisit.ActivePage := tabClinic;
 //end AWARE change
  pgeVisitChange(Self);
