KIDS Distribution saved on Nov 25, 2015@14:32:51
OR*3*418
**KIDS**:OR*3.0*418^
...
OR*3.0*418
"BLD",9325,0)
OR*3.0*418^ORDER ENTRY/RESULTS REPORTING^0^3150827^y
"BLD",9325,1,0)
^^1^1^3150825^
"BLD",9325,1,1,0)
...
OR CPRS GUI CHART^^0
"BLD",9325,"KRN",19,"NM","B","OR CPRS GUI CHART",1)
...
"BLD",9325,"REQB",1,0)
OR*3.0*404^2
"BLD",9325,"REQB","B","OR*3.0*404",1)

"KRN",19,10989,-1)
0^1
"KRN",19,10989,0)
OR CPRS GUI CHART^CPRSChart version 1.0.30.69^^B^^^^^^^^
"KRN",19,10989,1,0)
^19.06^2^2^3150827^^^^
"KRN",19,10989,1,1,0)
