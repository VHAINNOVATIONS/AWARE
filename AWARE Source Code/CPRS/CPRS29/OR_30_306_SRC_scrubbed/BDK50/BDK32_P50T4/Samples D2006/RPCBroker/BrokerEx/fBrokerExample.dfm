object frmBrokerExample: TfrmBrokerExample
  ...
  Caption = 'RPCBroker Example UCX RPCBroker (p50) SSH and CCOW enabled'
  ClientHeight = 389
  ClientWidth = 472
  Color = clBtnFace
  ...
  object MainMenu1: TMainMenu
    ...
    object mnuOptions: TMenuItem
      ...
      object mnuOptOldConnectionOnly: TMenuItem
        ...
        Hint = 'Broker works only with old style listeners on the server.'
      end
      ...
      object mnuOptDebugMode: TMenuItem
        Action = actDebugMode
        Hint = 
          'Sets up to enter with Debug Mode (There is a difference between ' +
          'old and new style listeners for debugging)'
      end
  ...
  object ActionList1: TActionList
    ...
    object actBackwardCompatible: TAction
      ...
      Checked = True
      Hint = 
        'Broker is able to connect to new style and old style listeners o' +
        'n the server | Broker long hint'
