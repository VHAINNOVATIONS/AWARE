unit rCore;
 //AWARE changes 1/27/2014 alert followup action checked before delete
interface

//AWARE changes
//uses SysUtils, Classes, Forms, ORNet, ORFn, ORClasses;
 uses SysUtils, Classes, Forms, ORNet, ORFn, ORClasses,Dialogs;
//end AWARE change
...
uses Hash, uCore, ShlObj, Windows,uEventHooks;
//end AWARE change
...
//AWARE changes
const
  Param2 = 'Single Alert Delete Check' ;
  Param3 = '' ;
...
begin
                ...
                //If Data2= 'No Delete' then ShowMessage('Alert Renew') ;
                if (Data2='')  then
                begin
                    ////AWAREchange end
