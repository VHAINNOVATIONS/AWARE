...
uses
  Classes, ORfn, ORCtrls, ComObj, ActiveX, write4cprsext_TLB, StdVcl,CPRSChart_TLB,Trpcb,Mfunstr,FmCmpnts,
   DiTypLib,Forms,Windows,ORSystem,extctrls,Messages, AlertIntercept1, FAT3_textok, StdCtrls ,FAT4_textok;
...
uses ComServ, Dialogs,SysUtils,db,comctrls, rMisc,Controls;
