...
/*SQL below. Re-position fields in logical order of importance*/
...
GO
/*NEXT, reduce to entry MATCHED APPT DATETIME TO VISTAVISTADATE TO JUST 1ST ONE ON 1ST CONSULTINITIATION DATE =APPT DATE WITH ROW SEARCH =1*/
USE consults
...
l26.OrderingInstitutionSID,l26.RoutingInstitutionSID,
