...
namespace AwareQIManager
{
    public partial class Admin : System.Web.UI.Page
    {
        ...
        private int _PopulateQiGroups()
        {
            ...
            ListItem dummyItem = new ListItem("<Select a group..>");
            dummyItem.Value = new Guid().ToString();
            DlstVisQiGrps.Items.Add(dummyItem);            
        ...
        protected void BtnUsersEdit_Click(object sender, EventArgs e)
        {
            ...
            if (selUser != null)
            {
                TbxUserName.Text = selUser.Text;
                Session["UsersIdBeingEdited"] = selUser.Value;
                TbxVerifyCode.Text = m_Encrypter.DecryptString(m_AwHelpers.AwareUsers.GetUserVerifyCode(Guid.Parse(Session["UsersIdBeingEdited"].ToString())));
            }
        }
        ...
        protected void BtnVistaGrpEdit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                TbxVisGrp.Text = selGrp.Text;
                int idx = DlstVisQiGrps.Items.IndexOf(DlstVisQiGrps.Items.FindByValue(m_AwHelpers.VistaGroups.GetAwareGroupIdByVistaGrpName(Guid.Parse(Session["VistaGrpIdBeingEdited"].ToString())).ToString()));
