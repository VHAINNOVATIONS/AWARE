...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <asp:Table ID="TblLogout" runat="server" Width="100%">
                <asp:TableRow runat="server">
                    ...
                    <asp:TableCell HorizontalAlign="Center" Width="25%">                      
                        <asp:Label ID="lblLastUpdated" runat="server" Text="This is a test" BackColor="#FFFF99"></asp:Label>
                    </asp:TableCell> 
    ...
    <asp:Panel ID="pnlRptParameters" runat="server" Width="100%" BackColor="#CCCCCC">
        ...
        <asp:Panel ID="TitlePanel" runat="server" CssClass="collapsePanelHeader">
                <asp:Image ID="Image1" runat="server" ImageUrl="images/expander.bmp" AlternateText="Expander" />
                    &nbsp;&nbsp;
         ...
         <div id="FacSrv" runat="server">
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell Width="300">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorFacility5" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlFacilities_5"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                        ...
                        <asp:TableCell Width="300" HorizontalAlign="Left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorService5" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlServices_5"  InitialValue="...Select a Value..." ValidationGroup="ViewReports"></asp:RequiredFieldValidator>
                        </asp:TableCell>                        
                    </asp:TableRow>
                </asp:Table>
            </div>
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell Width="300">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlFacilities_4"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                        <asp:TableCell Width="20" />
                        <asp:TableCell Width="120" HorizontalAlign="Right" VerticalAlign="Top">
                        ...
                        <asp:TableCell Width="300" HorizontalAlign="Left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorService4" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlServices_4"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                        <asp:TableCell Width="20" />
                        ...
                        <asp:TableCell Width="300" HorizontalAlign="Left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorClinic4" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlClinics_4"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </div>
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell Width="300" VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorFacility3" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlFaclilities_3" InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                    </asp:TableRow>
                    </asp:Table>
            </div>
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell Width="300">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorFacility2" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlFacilities_2" InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                         <asp:TableCell Width="20" />
                        <asp:TableCell Width="120" HorizontalAlign="Right" VerticalAlign="Top">
                        ...
                        <asp:TableCell Width="300" HorizontalAlign="Left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorProvider2" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlProviders_2"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </div>
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell Width="300" VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorFacility1" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlFacilities_1"   InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                        <asp:TableCell Width="20" />
                        <asp:TableCell Width="120" HorizontalAlign="Right" VerticalAlign="Top">
                        ...
                        <asp:TableCell Width="300" HorizontalAlign="Left" VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorService1" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlServices_1"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                        <asp:TableCell Width="20" />
                        <asp:TableCell Width="120" HorizontalAlign="Right" VerticalAlign="Top">
                        ...
                        <asp:TableCell Width="300" HorizontalAlign="Left" VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorProvider1" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlProviders_1"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </div>
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell Width="300" VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorFacility" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlFacilities" InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                        <asp:TableCell Width="20" />
                        <asp:TableCell Width="120" HorizontalAlign="Right" VerticalAlign="Top">
                        ...
                        <asp:TableCell Width="300" HorizontalAlign="Left" VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorService" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlServices"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                        <asp:TableCell Width="20" />
                        <asp:TableCell Width="80" HorizontalAlign="Right" VerticalAlign="Top">
                        ...
                        <asp:TableCell Width="300" HorizontalAlign="Left" VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorClinic" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlClinics"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                    </asp:TableRow>
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell  Width="300" HorizontalAlign="Left" VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorProvider" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlProviders"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                        <asp:TableCell Width="20" />
                        <asp:TableCell Width="120" HorizontalAlign="Right" VerticalAlign="Top">
                        ...
                        <asp:TableCell  Width="300" HorizontalAlign="Left" VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorAlertType" runat="server" ErrorMessage="Required" ForeColor="Red" 
                                ControlToValidate="ddlAlertTypes"  InitialValue="...Select a Value..." ValidationGroup="ViewReports" ></asp:RequiredFieldValidator>
                        </asp:TableCell>
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell Width="355" VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorStartDate" runat="server" 
                                ControlToValidate = "TbAlertStartDate" 
                                Display = "Dynamic" ForeColor="Red" 
                                ErrorMessage="Required" 
                                SetFocusOnError = "true"
                                ValidationGroup="ViewReports" 
                                Enabled="true">
                            </asp:RequiredFieldValidator>  
                           <asp:CompareValidator runat="server" ID="CompareValidatorTextBoxStartDate" 
                                Enabled="true" 
                                ForeColor="Red"  
                                Display="Dynamic"  
                                ValidationGroup="ViewReports"
                                ...
                                ErrorMessage="Start Date needs to be in the following format: mm/dd/yyyy and today or earlier.">
                        ...
                        <asp:TableCell VerticalAlign="Top">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorEndDate" runat="server" 
                                ControlToValidate = "TbAlertEndDate" 
                                Display = "Dynamic" ForeColor="Red" 
                                ErrorMessage="Required" 
                                SetFocusOnError = "true"
                                ValidationGroup="ViewReports" 
                           ...
                           <asp:CompareValidator runat="server" ID="CompareValidatorTextBoxEndDate" 
                                Enabled="true" 
                                ForeColor="Red"  
                                Display="Dynamic"  
                                ValidationGroup="ViewReports"
                                ...
                                ControlToValidate = "TbAlertEndDate"                         
                                Operator = "LessThanEqual" 
                                ErrorMessage="End Date needs to be in the following format: mm/dd/yyyy and today or earlier.">
                            </asp:CompareValidator>
                         </asp:TableCell>
                    </asp:TableRow>                    
                </asp:Table>
            ...
            <div style="text-align:center">
                ...
                <asp:Button ID="btnViewReport" runat="server" Text="View Report" 
                    onclick="btnViewReport_Click" ValidationGroup="ViewReports" />
