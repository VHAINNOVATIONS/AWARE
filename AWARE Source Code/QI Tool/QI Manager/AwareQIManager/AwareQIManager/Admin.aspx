...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
    ...
    <asp:Panel ID="PnlAddEditGroup" runat="server" Width="100%" BackColor="Gray" BorderStyle='Groove' >   
        ...
        <br />
            ...
            <center>
                <asp:Button ID="BtnGroupApply" runat="server" Text="Apply Changes" onclick="BtnGroupApply_Click" />
            </center>
    ...
    <br />
        <asp:Table ID="Table7" runat="server">
            <asp:TableRow>
                ...
                <asp:TableCell><asp:DropDownList ID="DlstVisGrpFac" runat="server" Width="300px"></asp:DropDownList></asp:TableCell>                    
            </asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                 ...
                 <asp:TableCell><asp:DropDownList ID="DlstVisQiGrps" runat="server" Width="300px"></asp:DropDownList></asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow Height="10px" />
            <asp:TableRow>
                <asp:TableCell />
        ...
        <asp:Panel ID="Panel6" runat="server" Width="100%" BackColor="Gray" HorizontalAlign="Center">
            <asp:Button ID="VistaGrpApplyChanges" runat="server" Text="Apply Changes" onclick="VistaGrpApplyChanges_Click" />
            <br />
        </asp:Panel>
     ...
     <br />
        <asp:Table ID="Table8" runat="server">
            <asp:TableRow>
                ...
                <asp:TableCell><asp:DropDownList ID="DdlUsersFac" runat="server" Width="300px"></asp:DropDownList></asp:TableCell>    
            </asp:TableRow>
            <asp:TableRow Height="10px" />
            <asp:TableRow>
        ...
        <asp:Panel ID="Panel8" runat="server" Width="100%" BackColor="Gray" HorizontalAlign="Center">
            <asp:Button ID="BtnUsersApply" runat="server" Text="Apply Changes" onclick="BtnUsersApplyChanges_Click" />
            <br />
        </asp:Panel>
    </asp:Panel>
    ...
    <br />
        <asp:Table ID="Table9" runat="server">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="TbxPresName" runat="server" width="400px"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <br />   
